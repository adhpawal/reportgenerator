...
<div class="container">
    <div class="row">
        ...
        <#if transactionInvoice.senderState=="CA">
            <img width="200px" src="https://s3.amazonaws.com/com-machpay-raas/assets/logo_moneytun_california.png"
                 class="someClass "></img>
        <#else>
            <img width="200px" src="https://s3.amazonaws.com/com-machpay-raas/assets/logo_moneytun.png"
                 class="someClass "></img>
        </#if>
        </div>
    ...
    <div class="row p-text">
        <table>
            ...
            <tr>
                ...
                <td class="amount"><p>${transactionInvoice.fee!}
                    /${transactionInvoice.extraFee!} ${transactionInvoice.senderCurrency!}</p></td>
            ...
            <tr>
                ...
                <td class="amount bold-text">
                    <p>${transactionInvoice.senderTotalAmount!} ${transactionInvoice.senderCurrency!}</p></td>
            ...
            <tr>
                ...
                <td class="amount bold-text">
                    <p>${transactionInvoice.receiverAmount!} ${transactionInvoice.receiverCurrency!}</p></td>
            </tr>
    ...
    <div class="row">
        ...
        <div class="disclaimer-note">
            <p>You, the customer, are entitled to a refund of the money to be transmitted as the result of this
                agreement if ${transactionInvoice.msbName!}
                does not forward the money received from you within 10 days of the date of its receipt, or does not give
                instructions
                committing an equivalent amount of money to the person designated by you within 10 days of the date of
                the receipt of the
                funds from you unless otherwise instructed by you.</p>

            <p>
                If your instructions as to when the moneys shall be forwarded or transmitted are not complied with and
                the money has not yet
                been forwarded or transmitted, you have a right to a refund of your money.
            </p>

            <p>
                If you want a refund, you must mail or deliver your written request to ${transactionInvoice.msbName!}
                at ${transactionInvoice.msbAddress!}.
                If you do not receive your refund, you may be entitled to your money back plus a penalty of up to $1,000
                and
